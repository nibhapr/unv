...
const Hero = () => {
  return (
    ...
    <><div className=" dark:bg-gray-900 p-12 ">
      <div className="grid max-w-screen-7xl px-8 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex mt-8">
